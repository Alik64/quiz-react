export const questions = [
    ...
    },
    {
        ...
        code: [
            ...
            { line: 2, text: "\v constructor(props) {" },
            { line: 3, text: "\v \v super(props);" },
            { line: 4, text: "\v \v // Missing line" },
            { line: 5, text: "\v }" },
            { line: 6, text: "\v handleClick() {...}" },
            { line: 7, text: "}" }],
        answers: [
    ...
    },
    {
        ...
        code: [
            ...
            { line: 2, text: "\v constructor(props) {" },
            { line: 3, text: "\v \v super(props);            " },
            { line: 4, text: "\v \v this.state = { count: 0 };            " },
            { line: 5, text: "\v }" },
            { line: 6, text: "\v render() {" },
            { line: 7, text: "\v \v return <h1>{}</h1>;" },
            { line: 8, text: "\v }" },
            { line: 9, text: "}" },
        ],
        answers: [
    ...
    },
    {
        ...
        code: [
            ...
            { line: 2, text: "\v <h1>Hi</h1>" },
            { line: 3, text: "\v \v document.getElementById('root')" },
            { line: 4, text: ")" },
        ],
        answers: [
    ...
    },
    {
        ...
        code: [
            ...
            { line: 2, text: "\v <h1>{children.length}</h1>" },
            { line: 3, text: ")" },
            { line: 4, text: "..." },
            { line: 5, text: "<MyComponent>" },
            { line: 6, text: "\v <p>Hello</p>" },
            { line: 7, text: "\v <p>Hello again</p>" },
    ...
    },
    {
        ...
        code: [
            { line: 1, text: "render() {" },
            { line: 2, text: "\v const isLoggedIn = this.state.isLoggedIn;" },
            { line: 3, text: "\v return (" },
            { line: 4, text: "\v \v <div>" },
            { line: 5, text: "\v \v \v The user is" },
            { line: 6, text: "\v \v </div>" },
            { line: 7, text: "\v );" },
            { line: 8, text: "}" },
        ],
    ...
    },
    {
        ...
        code: [
            ...
            { line: 2, text: "\v firePhotonTorpedoes(e) {                " },
            { line: 3, text: "\v \v console.log('pew pew');   " },
            { line: 4, text: "\v }" },
            { line: 5, text: "\v render() {                " },
            { line: 6, text: "\v \v return; // Missing code   " },
            { line: 7, text: "\v };" },
            { line: 8, text: "}" },
        ],
        answers: [
